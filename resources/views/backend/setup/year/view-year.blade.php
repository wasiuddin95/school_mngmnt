                ...
                <section class="col-md-12 ">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Year List
                                <a href="{{ route('setups.student.year.add') }}"
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="{{$value->id}}">
                                        ...
                                        <td>{{ $value->name }}</td>
                                        <td>
                                            <a href="{{ route('setups.student.year.edit',$value->id) }}" title="Edit"
                                                class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                            {{-- Delete --}}
                                            <a href="{{ route('setups.student.year.delete',$value->id) }}" id="delete"

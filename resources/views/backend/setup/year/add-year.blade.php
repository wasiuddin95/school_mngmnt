                        ...
                        <div class="card-header">
                            <h3>
                                ...
                                <a href="{{ route('setups.student.year.view') }}"
                                    class="btn btn-success float-right btn-sm"><i class="fa fa-list"></i> Year
                                    List</a>
                            </h3>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <form
                                action="{{ (@$editData)?route('setups.student.year.update',$editData->id):route('setups.student.year.store') }}"
                                ...
                                <div class="card-body">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" value="{{ @$editData->name }}" name="name"
                                            class="form-control" placeholder="Enter Year Name">

                        ...
                        <div class="card-header">
                            <h3>
                                ...
                                <a href="{{ route('setups.student.group.view') }}"
                                    class="btn btn-success float-right btn-sm"><i class="fa fa-list"></i> Group
                                    List</a>
                            </h3>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <form
                                action="{{ (@$editData)?route('setups.student.group.update',$editData->id):route('setups.student.group.store') }}"

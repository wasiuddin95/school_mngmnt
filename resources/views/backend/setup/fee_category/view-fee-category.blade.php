                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Fee Category List
                                <a href="{{ route('setups.fee.category.add') }}"
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="{{$value->id}}">
                                        ...
                                        <td>{{ $value->name }}</td>
                                        <td>
                                            <a href="{{ route('setups.fee.category.edit',$value->id) }}" title="Edit"
                                                class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                            {{-- Delete --}}
                                            <a href="{{ route('setups.fee.category.delete',$value->id) }}" id="delete"

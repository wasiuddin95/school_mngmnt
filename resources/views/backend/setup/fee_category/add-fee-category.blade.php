                        ...
                        <div class="card-header">
                            <h3>
                                ...
                                <a href="{{ route('setups.fee.category.view') }}"
                                    class="btn btn-success float-right btn-sm"><i class="fa fa-list"></i> Fee Category
                                    List</a>
                            </h3>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <form
                                action="{{ (@$editData)?route('setups.fee.category.update',$editData->id):route('setups.fee.category.store') }}"
                                ...
                                <div class="card-body">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" value="{{ @$editData->name }}" name="name"
                                            class="form-control" placeholder="Enter Fee Category Name">

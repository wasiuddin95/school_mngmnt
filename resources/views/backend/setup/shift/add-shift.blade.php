                        ...
                        <div class="card-header">
                            <h3>
                                ...
                                <a href="{{ route('setups.student.shift.view') }}"
                                    class="btn btn-success float-right btn-sm"><i class="fa fa-list"></i> Shift
                                    List</a>
                            </h3>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <form
                                action="{{ (@$editData)?route('setups.student.shift.update',$editData->id):route('setups.student.shift.store') }}"
                                ...
                                <div class="card-body">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" value="{{ @$editData->name }}" name="name"
                                            class="form-control" placeholder="Enter Shift Name">

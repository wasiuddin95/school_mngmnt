                        ...
                        <div class="card-header">
                            <h3>
                                ...
                                <a href="{{ route('setups.designation.view') }}"
                                    class="btn btn-success float-right btn-sm"><i class="fa fa-list"></i> Designation
                                    List</a>
                            </h3>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <form
                                action="{{ (@$editData)?route('setups.designation.update',$editData->id):route('setups.designation.store') }}"
